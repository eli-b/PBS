...
void ComputeHeuristic::getHVals(vector<int>& res)
{
    ...
    boost::heap::pairing_heap<Node*, boost::heap::compare<Node::compare_node>>::handle_type open_handle;
    ...
    boost::unordered_map<Node*, pairing_heap<Node*, boost::heap::compare<Node::compare_node>>::handle_type, Node::NodeHasher, Node::eqnode> nodes;
    boost::unordered_map<Node*, pairing_heap<Node*, boost::heap::compare<Node::compare_node>>::handle_type, Node::NodeHasher, Node::eqnode>::iterator it; // will be used for find()
    ...
    while (!heap.empty())
    {
        ...
        for (int direction = 0; direction < 5; direction++)
        {
            ...
            if (0 <= next_loc && next_loc < map_rows * map_cols && !my_map[next_loc] &&
                abs(next_loc % moves_offset[MapLoader::valid_moves_t::SOUTH] -
